...
#line 2 "../hw/sh4/trace-events"
            qemu_log("%d@%zu.%06zu:sh7750_porta " "porta changed from 0x%04x to 0x%04x (pdtra=0x%04x, pctra=0x%08x)" "\n",
                     qemu_get_thread_id(),
...
#line 3 "../hw/sh4/trace-events"
            qemu_log("%d@%zu.%06zu:sh7750_portb " "portb changed from 0x%04x to 0x%04x (pdtrb=0x%04x, pctrb=0x%08x)" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , prev, cur, pdtr, pctr);
